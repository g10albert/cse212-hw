...
public static class Recursion
{
    ...
    public static int SumSquaresRecursive(int n)
    {
        ...
        // Recursive step: n^2 + SumSquaresRecursive(n - 1)
    ...
    {
        // Base case: when word length matches requested size
        if (word.Length == size)
        {
            results.Add(word);
            return;
        ...
        // Recursive case: pick each remaining letter and recurse
    ...
    public static void SolveMaze(List<string> results, Maze maze, int x = 0, int y = 0, List<ValueTuple<int, int>>? currPath = null)
    {
        ...
        {
            // Recursive steps: explore 4 possible directions (Up, Down, Left, Right)
